...
| 独立职位简历 | 本地实现与验证完成；migration 018 尚未上线 | [副本契约及测试记录](../architecture/RESUME_VARIANTS.md) |
...
| --- | --- | --- | --- |
| R1 职位简历交付 | P0；本地完成，待发布 | 每个职位有独立可编辑简历，基础版与副本互不影响 | 备份恢复、018 迁移和发布检查；真实副本保存、重开、预览及 Word/PDF 导出；基础内容不变 |
